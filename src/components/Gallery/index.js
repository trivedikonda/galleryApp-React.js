...
class Gallery extends Component {
  ...
  renderImgFromSelectedThumbnail = () => {
    const {activeImageId} = this.state
    const {imageAltText, imageUrl} = imagesList[activeImageId]
    return <img className="each-img" src={imageUrl} alt={imageAltText} />
  }
    ...
    return (
      <div className="app-container">
        <div className="container">
          <div>{this.renderImgFromSelectedThumbnail()}</div>
